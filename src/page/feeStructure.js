...
const FeesStructure = () => {
    return (
        <div className='h-auto items-center flex flex-col'>
            ...
            <div className="flex flex-col md:flex-row h-[90%] gap-6">
                {coursesList.map((course) => (
                    <div key={course.id} className="flex h-[100%] mb-10 p-2 flex-col rounded-lg shadow-lg overflow-hidden">
                        <div className="max-w-sm min-h-[90%] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <Link to={course.link} className="inline-flex items-center px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Read more
